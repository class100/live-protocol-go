...
type Video struct {
	...
	// 类型
	Type VideoType `protobuf:"varint,1,opt,name=type,proto3,enum=live.VideoType" json:"type,omitempty"`
	// 流地址
...
func (x *Video) GetType() VideoType {
	...
	return VideoType_AUDIO
}

func (x *Video) GetUrls() []*Url {
	if x != nil {
		return x.Urls
	}
	return nil
...
var file_video_proto_rawDesc = []byte{
	,
}
...
var file_video_proto_goTypes = []interface{}{
	(*Video)(nil),  // 0: live.Video
	(VideoType)(0), // 1: live.VideoType
	(*Url)(nil),    // 2: live.Url
}
var file_video_proto_depIdxs = []int32{
	1, // 0: live.Video.type:type_name -> live.VideoType
	2, // 1: live.Video.urls:type_name -> live.Url
